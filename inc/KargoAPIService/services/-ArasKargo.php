...
class ArasCargoHandler{
    ...
    public function delivery(){
        ...
        $TarihExp = explode("/", @$this->DataSet->Cargo->TESLIM_TARIHI);

        $Tarih = @$TarihExp[2]."-".@$TarihExp[1]."-".@$TarihExp[0];
    ...
    public function renderArray(){
        ...
        return json_decode(json_encode($this->DataSet->Cargo), true);
    ...
    public function renderObject(){
        ...
        foreach($this->DataSet->Cargo AS $key => $Cargo){
        ...
        return (object) $this->DataSet->Cargo;
