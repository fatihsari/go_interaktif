                ...
                <div id="f1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control " id="urun_id" name="urun_id" style="width:400px"
                                ...
                                $urunler = $db->get_results("SELECT * FROM `urunler` WHERE `urun_fiyati` > 0 AND  Durumu=0");
                    ...
                    <script type="text/javascript">
                        function Gts() {
                            ...
                            $("#alt_drm_view").html(" ");
                            if (durum == 4 || durum == 5) {
                                $.post("inc/case.php?ido=415285101", {durum: durum, selected: <?=$row->alt_durum_id;?>}, function (donenVeri) {
                                    var donen = donenVeri;
